...
- time_to_eat: (optional) The minimum number of times each philosopher must eat before the simulation ends. If not provided, the simulation will stop only when a philosopher dies, and will run forever if none of them die.
