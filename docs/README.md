...
## Notes
The documentation used here may be out of date. It's important to keep up to date with the changes to the subject documents, since updates usually either bring new requirements, or clear inconsistencies and misunderstandings about some aspects. Always use the document provided to you in Intra.
